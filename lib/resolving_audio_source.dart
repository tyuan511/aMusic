...
class ResolvingAudioSource extends StreamAudioSource {
  ...
  ResolvingAudioSource({required this.uniqueId, required this.resolveSoundUrl, this.headers, dynamic tag})
      : super(tag: tag);
  ...
  Future<StreamAudioResponse> request([int? start, int? end]) async {
    ...
    if (soundUrl == null) {
      return StreamAudioResponse(
          sourceLength: null, contentLength: null, offset: null, stream: const Stream.empty(), contentType: '');
    }
